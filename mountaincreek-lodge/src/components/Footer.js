    ...
    <footer className="w-full bg-primary text-linen pt-16 pb-12">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 mt-16 pt-8 border-t border-linen/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-linen/40 font-medium tracking-wider">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex gap-4 ml-2 border-l border-linen/20 pl-6">
            <a href="https://www.facebook.com/profile.php?id=61564501787845" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors" aria-label="Facebook">
            ...
            <a href="https://www.instagram.com/_mountaincreeklodge" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors" aria-label="Instagram">
