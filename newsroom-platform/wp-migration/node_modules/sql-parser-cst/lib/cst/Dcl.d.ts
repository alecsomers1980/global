...
import { Identifier, ListExpr, EntityName, Expr, ParenExpr, FuncCall } from "./Expr";
import { FunctionSignature } from "./Function";
import { BooleanLiteral, StringLiteral } from "./Literal";
import { RoleSpecification } from "./Role";
export type AllDclNodes = AllDclStatements | Privilege | AllPrivileges | GrantResource | WithGrantOptionClause | GrantOptionForClause | GrantedByClause | GranteeGroup | GranteePublic | GrantDefaultPrivilegesAction | RevokeDefaultPrivilegesAction | DefaultAclForRoleClause | DefaultAclInSchemaClause;
export type AllDclStatements = GrantPrivilegeStmt | GrantRoleStmt | RevokePrivilegeStmt | RevokeRoleStmt | AlterDefaultPrivilegesStmt;
...
export interface Privilege extends BaseNode {
    type: "privilege";
    privilegeKw: Keyword<"SELECT" | "INSERT" | "UPDATE" | "DELETE" | "TRUNCATE" | "REFERENCES" | "TRIGGER" | "MAINTAIN" | "USAGE" | "CREATE" | "CONNECT" | "TEMPORARY" | "TEMP" | "SET" | "EXECUTE"> | [Keyword<"ALTER">, Keyword<"SYSTEM">];
...
export type GrantResource = GrantResourceTable | GrantResourceAllTablesInSchema | GrantResourceSequence | GrantResourceAllSequencesInSchema | GrantResourceDatabase | GrantResourceDomain | GrantResourceForeignDataWrapper | GrantResourceForeignServer | GrantResourceFunction | GrantResourceAllFunctionsInSchema | GrantResourceLanguage | GrantResourceLargeObject | GrantResourcePostgresqlOption | GrantResourceSchema | GrantResourceTablespace | GrantResourceType | GrantResourceView;
...
export interface AlterDefaultPrivilegesStmt extends BaseNode {
    ...
    clauses: (DefaultAclForRoleClause | DefaultAclInSchemaClause)[];
    action: GrantDefaultPrivilegesAction | RevokeDefaultPrivilegesAction;
}
export interface DefaultAclForRoleClause extends BaseNode {
    type: "default_acl_for_role_clause";
    forKw: Keyword<"FOR">;
    roleKw: Keyword<"ROLE" | "USER">;
    roles: ListExpr<RoleSpecification>;
}
export interface DefaultAclInSchemaClause extends BaseNode {
    type: "default_acl_in_schema_clause";
    inKw: Keyword<"IN">;
    schemaKw: Keyword<"SCHEMA">;
    schemas: ListExpr<Identifier>;
}
...
type ResourcesKeyword = Keyword<"TABLES" | "SEQUENCES" | "FUNCTIONS" | "ROUTINES" | "TYPES" | "SCHEMAS"> | [Keyword<"LARGE">, Keyword<"OBJECTS">];
export {};
