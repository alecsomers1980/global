...
export type Statement = AllAlterTableStatements | AllBigqueryStatements | AllCommentStatements | AllDclStatements | AllDomainStatements | AllExtensionNodes | AllFunctionStatements | AllIndexStatements | AllPolicyStatements | AllPreparedStatements | AllProceduralStatements | AllProcedureStatements | AllPublicationStatements | AllSchemaStatements | AllSequenceStatements | AllSubscriptionNodes | AllParameterStatements | AllSqliteStatements | AllTransactionStatements | AllTriggerStatements | AllTypeStatements | AllViewStatements | AnalyzeStmt | CompoundSelectStmt | CreateTableStmt | DeleteStmt | DoStmt | DropTableStmt | Empty | ExplainStmt | InsertStmt | MergeStmt | SelectStmt | TruncateStmt | UpdateStmt | UnsupportedGrammarStmt;
