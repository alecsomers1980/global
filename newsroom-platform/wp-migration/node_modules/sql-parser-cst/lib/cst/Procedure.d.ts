...
import { DynamicallyLoadedFunction, FunctionParam, FunctionSecurityClause, FunctionTransformClause } from "./Function";
...
type CreateProcedureClause = BlockStmt | BigqueryOptions | WithConnectionClause | LanguageClause | AsClause<StringLiteral | DynamicallyLoadedFunction> | FunctionSecurityClause | FunctionTransformClause | SetParameterClause | SetParameterFromCurrentClause;
...
type AlterProcedureClause = SetParameterClause | SetParameterFromCurrentClause | ResetParameterClause | FunctionSecurityClause;
export {};
