...
import { AsClause, DeterminismClause, LanguageClause, WithConnectionClause, ReturnsClause } from "./ProcClause";
import { SubSelect } from "./Select";
import { BlockStmt } from "./ProceduralLanguage";
import { AlterFunctionAction } from "./AlterAction";
import { ResetParameterClause, SetParameterClause, SetParameterFromCurrentClause } from "./Parameter";
export type AllFunctionNodes = AllFunctionStatements | FunctionSignature | FunctionParam | FunctionParamDefault | ReturnClause | DynamicallyLoadedFunction | FunctionWindowClause | FunctionBehaviorClause | FunctionSecurityClause | FunctionCostClause | FunctionRowsClause | FunctionSupportClause | FunctionTransformClause | TransformType;
...
type CreateFunctionClause = ReturnsClause | ReturnClause | BlockStmt | DeterminismClause | LanguageClause | AsClause<StringLiteral | ParenExpr<Expr> | SubSelect | DynamicallyLoadedFunction> | BigqueryOptions | WithConnectionClause | FunctionWindowClause | FunctionBehaviorClause | FunctionSecurityClause | FunctionCostClause | FunctionRowsClause | FunctionSupportClause | FunctionTransformClause | SetParameterClause | SetParameterFromCurrentClause;
...
export interface FunctionBehaviorClause extends BaseNode {
    ...
    behaviorKw: Keyword<"VOLATILE"> | Keyword<"STABLE"> | Keyword<"IMMUTABLE"> | Keyword<"LEAKPROOF"> | [Keyword<"NOT">, Keyword<"LEAKPROOF">] | [Keyword<"CALLED">, Keyword<"ON">, Keyword<"NULL">, Keyword<"INPUT">] | [
        Keyword<"RETURNS">,
        Keyword<"NULL">,
        Keyword<"ON">,
        Keyword<"NULL">,
        Keyword<"INPUT">
    ] | Keyword<"STRICT"> | [Keyword<"PARALLEL">, Keyword<"UNSAFE" | "SAFE" | "RESTRICTED">];
}
...
type AlterFunctionClause = SetParameterClause | SetParameterFromCurrentClause | ResetParameterClause | FunctionBehaviorClause | FunctionSecurityClause | FunctionCostClause | FunctionRowsClause | FunctionSupportClause;
export {};
