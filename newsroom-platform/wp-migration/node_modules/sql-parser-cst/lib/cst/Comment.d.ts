...
import { FunctionParam, ModifiedDataType } from "./Node";
...
type CommentTarget = CommentTargetAccessMethod | CommentTargetCast | CommentTargetCollation | CommentTargetColumn | CommentTargetTableConstraint | CommentTargetDomainConstraint | CommentTargetConversion | CommentTargetDatabase | CommentTargetDomain | CommentTargetExtension | CommentTargetEventTrigger | CommentTargetForeignDataWrapper | CommentTargetForeignTable | CommentTargetIndex | CommentTargetLargeObject | CommentTargetMaterializedView | CommentTargetOperatorClass | CommentTargetOperatorFamily | CommentTargetPolicy | CommentTargetLanguage | CommentTargetPublication | CommentTargetRole | CommentTargetRule | CommentTargetSchema | CommentTargetSequence | CommentTargetServer | CommentTargetStatistics | CommentTargetSubscription | CommentTargetTable | CommentTargetTablespace | CommentTargetTextSearchConfiguration | CommentTargetTextSearchDictionary | CommentTargetTextSearchParser | CommentTargetTextSearchTemplate | CommentTargetTransform | CommentTargetTrigger | CommentTargetType | CommentTargetView | CommentTargetAggregate | CommentTargetFunction | CommentTargetProcedure | CommentTargetRoutine;
...
export interface CommentTargetLanguage extends BaseNode {
    ...
    languageKw: Keyword<"LANGUAGE"> | [Keyword<"PROCEDURAL">, Keyword<"LANGUAGE">];
    name: EntityName;
}
