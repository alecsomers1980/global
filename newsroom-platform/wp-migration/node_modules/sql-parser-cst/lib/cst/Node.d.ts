...
export type Node = Alias | AllAlterActionNodes | AllAlterTableNodes | AllBigqueryNodes | AllCastNodes | AllColumns | AllCommentNodes | AllConstraintNodes | AllCreateTableNodes | AllDataTypeNodes | AllDclNodes | AllDeleteNodes | AllDomainNodes | AllExprNodes | AllExtensionNodes | AllFrameNodes | AllFunctionNodes | AllIndexNodes | AllInsertNodes | AllMergeNodes | AllMysqlNodes | AllOtherClauses | AllParameterNodes | AllPostgresqlNodes | AllPolicyNodes | AllPreparedStatementNodes | AllProcClauseNodes | AllProceduralNodes | AllProcedureNodes | AllPublicationNodes | AllRenameTableNodes | AllRoleNodes | AllSelectNodes | AllSequenceNodes | AllSqliteNodes | AllSubscriptionNodes | AllTransactionNodes | AllTriggerNodes | AllTypeNodes | AllUpdateNodes | AllViewNodes | Keyword | Program | Statement;
