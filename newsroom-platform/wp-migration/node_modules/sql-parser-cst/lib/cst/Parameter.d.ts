...
export type AllParameterNodes = AllParameterStatements | SetParameterClause | SetParameterFromCurrentClause | ResetParameterClause | AllParameters | LocalParameterValue | BooleanOnOffLiteral;
export type AllParameterStatements = SetParameterStmt | SetTimeZoneParameterStmt | ResetParameterStmt | ShowParameterStmt;
