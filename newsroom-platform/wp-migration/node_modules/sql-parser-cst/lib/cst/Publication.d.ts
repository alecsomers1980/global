import { AlterActionOwnerTo, AlterActionRename, AlterActionSetPostgresqlOptions } from "./AlterAction";
...
export type AllPublicationNodes = AllPublicationStatements | ForPublicationObjectsClause | AllPublicationObject | PublicationObjectTable | PublicationObjectTablesInSchema | AlterActionAddPublicationObjects | AlterActionDropPublicationObjects | AlterActionSetPublicationObjects;
export type AllPublicationStatements = CreatePublicationStmt | AlterPublicationStmt | DropPublicationStmt;
...
export interface ForPublicationObjectsClause extends BaseNode {
    ...
    forKw: Keyword<"FOR">;
    publicationObjects: ListExpr<AllPublicationObject> | ListExpr<PublicationObjectTable | PublicationObjectTablesInSchema>;
}
...
type AlterPublicationAction = AlterActionRename | AlterActionOwnerTo | AlterActionSetPostgresqlOptions | AlterActionAddPublicationObjects | AlterActionDropPublicationObjects | AlterActionSetPublicationObjects;
export interface AlterActionAddPublicationObjects extends BaseNode {
    type: "alter_action_add_publication_objects";
    addKw: Keyword<"ADD">;
    publicationObjects: ListExpr<PublicationObjectTable | PublicationObjectTablesInSchema>;
}
