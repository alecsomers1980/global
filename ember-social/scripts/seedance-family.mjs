...
if (!KIE_KEY) { console.error('KIE_API_KEY required'); process.exit(1) }
...
Shot 1: The maroon Hyundai Tucson from @Image 1 reverses gently out of a leafy suburban White River driveway in soft golden morning light, packed for a day trip, two adults just finishing loading the boot, camera tracking smoothly alongside, warm and unhurried real motion.

Shot 2: The maroon Hyundai Tucson from @Image 2 drives along a scenic green Panorama Route mountain curve, KEEPING TO THE LEFT-HAND SIDE OF THE ROAD (South Africa drives on the left, the centre line stays on the car's right), morning mist lifting off the escarpment, smooth sweeping cinematic tracking shot keeping pace with the moving car, a sense of the open road and possibility.
...
console.log('Uploading approved reference stills...')
const urls = []
