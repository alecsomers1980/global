...
## Corpus Check
- 212 files · ~124,466 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1089 nodes · 1736 edges · 137 communities (73 shown, 64 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `978fa02b`
...
Cohesion: 0.07
Nodes (74): CAR_PILLARS, currentSASeason(), POST(), RENDERERS, computeWeekday(), DOW, PillarDef, PILLARS (+66 more)
...
Cohesion: 0.13
Nodes (17): POST(), GET(), GET(), GET(), POST(), GET(), GET(), GET() (+9 more)
...
Cohesion: 0.13
Nodes (17): POST(), GET(), GET(), GET(), GET(), GET(), GET(), GET() (+9 more)
...
Cohesion: 0.13
Nodes (16): computeBestHours(), computeCadence(), engagementFb(), engagementIg(), FbPost, IgPost, POST(), POST() (+8 more)
...
Cohesion: 0.17
Nodes (17): POST(), confPath, fontsDir, applyBrandOverlay(), applyMultiCarOverlay(), applySellYoursOverlay(), applySpecCardOverlay(), applyTipCardOverlay() (+9 more)
...
Cohesion: 0.15
Nodes (13): POST(), Archetype, CampaignResult, clamp(), generateCampaign(), GeneratedPost, PILLAR_POOLS, PILLAR_STYLE_MAP (+5 more)
...
Cohesion: 0.20
Nodes (6): Props, Props, Page(), Props, WorkspacePage(), formatDate()
...
Cohesion: 0.22
Nodes (3): ALL_WEEKDAYS, SAST_WINDOW_UTC, TIME_BY_WEEKDAY

### Community 39 - "Community 39"
Cohesion: 0.43
Nodes (6): getNextAvailableDateForVehicle(), POST(), detectPostType(), openai, rewriteSocialContent(), isSunday()
...
Cohesion: 0.60
Nodes (3): ApprovePage(), DashboardPage(), formatDateTime()
...
## Knowledge Gaps
- **338 isolated node(s):** `everestEnv`, `emberEnv`, `supabase`, `eslintConfig`, `nextConfig` (+333 more)
...
- **Why does `resolveWorkspaceId()` connect `Intelligence Save & OAuth Init` to `Campaign Generate & Image-Change API`, `AI Caption & OAuth Callbacks`, `Social History Analyzer`, `AI Campaign Generator Core`, `Community 17`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `createServerSupabaseClient()` connect `AI Caption & OAuth Callbacks` to `Community 36`, `Intelligence Save & OAuth Init`, `Community 39`, `AI Campaign Generator Core`, `Community 21`, `Community 55`, `Community 28`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Database` connect `Approvals & Brand Kit Dashboard` to `Community 24`, `AI Caption & OAuth Callbacks`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **What connects `everestEnv`, `emberEnv`, `supabase` to the rest of the system?**
