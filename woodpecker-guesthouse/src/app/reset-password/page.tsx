...
export default function ResetPasswordPage() {
  ...
  // Client is only ever constructed inside effects/handlers (never during
  // render) — `useState(() => createClient())` runs its initializer during
  // Next's server-side prerender pass, which throws when Supabase env vars
  // aren't set yet. Confirmed by running `next build`.
  useEffect(() => {
