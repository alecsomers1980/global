...
export function StockistBand() {
  return (
    <section className="mx-auto mt-24 max-w-[1440px] px-6 md:px-16">
      <div className="flex flex-col gap-7 bg-brand px-8 py-12 text-brand-ink md:flex-row md:items-center md:justify-between md:px-14">
