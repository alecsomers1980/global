# Graph Report - everest-motoring  (2026-07-20)

## Corpus Check
- 283 files · ~130,517 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1084 nodes · 1293 edges · 197 communities (119 shown, 78 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `11a2f1cd`
...
4. `testTemplates()` - 9 edges
5. `fetchGaReport()` - 9 edges
6. `generateNewsArticle()` - 9 edges
...
## Communities (197 total, 78 thin omitted)

### Community 0 - "Inventory Admin & AI Actions"
Cohesion: 0.07
Nodes (22): metadata, getEngine(), optimizeDescriptionAction(), pollSingleClipAction(), preflightSceneImagesAction(), queueAiWalkaround(), NOTE: maxDuration cannot be exported from a "use server" module (Next.js, startSingleClipAction() (+14 more)
...
Cohesion: 0.08
Nodes (27): testTemplates(), testTemplates(), GET(), isAuthorized(), submitContactForm(), CONTACT_EMAIL, submitContactForm(), LEAD_NOTIFICATION_EMAIL (+19 more)

### Community 3 - "Post-Sale Scripts & React"
Cohesion: 0.09
Nodes (30): react, react, env, resend, supa, addDeliveryPhotoToSale(), addOffInventorySale(), getLeadsForCar() (+22 more)
...
Cohesion: 0.15
Nodes (20): deleteNewsPost(), generateNewsPost(), generateNewsPostAction(), pickFeaturedCar(), publishNewsPost(), requireAdmin(), uniqueSlug(), unpublishNewsPost() (+12 more)
...
Cohesion: 0.17
Nodes (12): addAffiliateAction(), approveAffiliateAction(), declineAffiliateAction(), deleteAffiliateAction(), getAffiliateBankDetails(), toggleAffiliateApproval(), AddAffiliateModal(), AffiliateApprovalToggle() (+4 more)

### Community 10 - "AI News Generator"
Cohesion: 0.15
Nodes (18): buildBuyingGuidePrompt(), buildLocalPrompt(), buildModelReviewPrompt(), BUYING_GUIDE_TOPICS, countWords(), _ctrlRe, DEALERSHIP, estimateReadingMinutes() (+10 more)
...
Cohesion: 0.19
Nodes (11): getApiKey(), pollSeedanceClip(), SEEDANCE_STYLE_PROMPTS, sleep(), startSeedanceClip(), motionDirectiveForScene(), pollCinematicTask(), NOTE: Seedance Fast only accepts specific clip durations (5s and 10s are (+3 more)

### Community 13 - "Community 13"
Cohesion: 0.37
Nodes (12): buildFeedPost(), buildReelPost(), buildVideoPost(), CONTACT, createSocialPost(), formatPrice(), getAllMedia(), getScheduleTimes() (+4 more)
...
Cohesion: 0.29
Nodes (6): saveFinancingDetailsAction(), uploadClientDocument(), FinancingDetailsForm(), metadata, REQUIRED_DOCS, UploadCard()
...
Cohesion: 0.36
Nodes (4): requireAdmin(), sendNewsletterAction(), metadata, SendNewsletterButton()
...
Cohesion: 0.48
Nodes (4): STYLES, pollTestHandoverVideo(), requireAdmin(), startTestHandoverVideo()
...
Cohesion: 0.18
Nodes (8): AiVideoStatus(), DeleteVehicleButton(), InventoryTable(), MarkSoldButton(), metadata, SeoFixButton(), formatSharedDate(), SocialPostButton()

## Knowledge Gaps
- **297 isolated node(s):** `microgramme`, `inter`, `siteConfig`, `metadata`, `TONES` (+292 more)
...
- **Are the 6 inferred relationships involving `testTemplates()` (e.g. with `ThreeYearTradeInEmail()` and `AffiliateMediaKit()`) actually correct?**
  _`testTemplates()` has 6 INFERRED edges - model-reasoned connections that need verification._
- **What connects `microgramme`, `inter`, `siteConfig` to the rest of the system?**
