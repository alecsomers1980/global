...
## Corpus Check
- 283 files · ~130,554 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1084 nodes · 1247 edges · 208 communities (125 shown, 83 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `712c02a3`
...
## Communities (208 total, 83 thin omitted)
...
Cohesion: 0.17
Nodes (16): testTemplates(), testTemplates(), brandConfig, ThreeYearTradeInEmail(), AffiliateMediaKit(), brandConfig, brandConfig, NewsletterEmail() (+8 more)

### Community 3 - "Post-Sale Scripts & React"
Cohesion: 0.20
Nodes (18): addDeliveryPhotoToSale(), addOffInventorySale(), getLeadsForCar(), getOfflineSales(), getSaleForCar(), markCarAsSold(), markCarAsSoldInner(), pollSaleVideo() (+10 more)
...
### Community 197 - "react"
Cohesion: 0.11
Nodes (13): react, react, GET(), submitContactForm(), CONTACT_EMAIL, submitContactForm(), LEAD_NOTIFICATION_EMAIL, submitLead() (+5 more)
...
### Community 201 - "test-postsale.mjs"
Cohesion: 0.33
Nodes (4): env, resend, supa, brandConfig

### Community 202 - "GET"
Cohesion: 0.40
Nodes (4): GET(), isAuthorized(), brandConfig, SixMonthFollowupEmail()

## Knowledge Gaps
- **298 isolated node(s):** `metadata`, `teamMembers`, `STATUS_STYLES`, `STYLES`, `CAR_FEATURES` (+293 more)
...
- **Why does `react` connect `react` to `Email Templates & Tests`, `Post-Sale Scripts & React`, `Affiliate Reports`, `dependencies`, `GET`, `Trade-Ins Admin`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `Third-Party Dependencies`, `AI Provider Chain`, `Package & Build Tooling`, `@anthropic-ai/sdk`, `clsx`, `framer-motion`, `@google-analytics/data`, `lucide-react`, `marked`, `@mux/mux-player-react`, `next`, `@radix-ui/react-dialog`, `@radix-ui/react-dropdown-menu`, `react-dom`, `@react-email/tailwind`, `@react-pdf/renderer`, `resend`, `@sentry/nextjs`, `@supabase/ssr`, `tailwind-merge`, `react`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `renderReportPdf()` connect `Affiliate Reports` to `react`, `Monthly Report Builder`?**
...
- **What connects `metadata`, `teamMembers`, `STATUS_STYLES` to the rest of the system?**
...
- **Should `Affiliate Reports` be split into smaller, more focused modules?**
