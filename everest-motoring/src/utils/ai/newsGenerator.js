...
- KEYWORD PLACEMENT: include the article's real target phrase — the specific model, topic, or search term a buyer would actually type — verbatim in both the title and meta_title fields. A 2026 study of 10,937 pages found 63% missing the exact keyword from the H1 and 60% from the title tag; Kyle Roof (PageOptimizer Pro) estimates this single fix "solves 70% of your problems". Do not paraphrase the phrase away for style.
...
- Source and expiry: adapted from Wikipedia's 'Signs of AI writing' (WikiProject AI Cleanup). AI tells are model-specific and drift with each release - re-validate the word lists against that guide on every major model release.`.trim();
