 ...
 * @param {number} [args.videoDurationMs=7000]  Total clip duration (Seedance scenes are 7s).
 ...
 */
export async function muxAudioOntoVideo({ videoUrl, audioUrl, videoDurationMs = 7000, audioDurationMs }) {
