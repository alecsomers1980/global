...
- A still photograph of the ${car.make} ${car.model} dashboard held on screen, slowly zooming in over 7 seconds (final scale ~110% of starting frame). The dashboard, displays, and steering wheel are identical to the source photograph throughout. The steering wheel is on the RIGHT side (right-hand-drive vehicle). Nothing in the photograph moves; only the magnification gradually grows.
...
Scene 3: Rear Cabin
- A still photograph of the ${car.make} ${car.model} rear cabin held on screen, slowly zooming in over 7 seconds (final scale ~110% of starting frame). The seats, trim, and view through the windows are identical to the source photograph throughout. Nothing in the photograph moves; only the magnification gradually grows.
