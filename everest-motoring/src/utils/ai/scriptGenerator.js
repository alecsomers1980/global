...
2d. VOICEOVER LENGTH — STRICT: every voiceover line must be MAX 14 WORDS. Each clip is 10 seconds long, so the line must comfortably fit at a calm, unhurried pace with room to breathe at the end. If you cannot fit your point in 14 words, say less — drop a feature, drop an adjective, drop the lead-in. A short, well-spoken line is far better than a long line that gets cut off mid-sentence. Aim for 11–13 words.
...
4. MOTION — every scene is a still photograph being slowly zoomed-in over 10 seconds (Ken Burns / cinemagraph style). The image's content does not move; only its on-screen scale grows from roughly 100% to roughly 110% by the end of the clip. There is no panning, no rotation, no angle change, no perspective shift, and nothing in the scene itself moves. The source photograph remains the same throughout — only its magnification gradually increases.

Scene Breakdown:

(STYLE — applies to all four scenes: each clip is a SINGLE FLUID 10-second photo animation. The source reference image is held on screen and slowly scales up by ~10%. Treat the input strictly as a flat photograph being magnified — not a 3D scene being filmed. The image's framing, angle, perspective, lighting, and content are identical from frame one to the last frame; only the zoom level grows. The animation is one continuous fluid motion with no cuts, no angle changes, no panning, and no mid-clip variation.)

Scene 1: Exterior Hero
- A still photograph of the ${car.make} ${car.model} held on screen, slowly zooming in over 10 seconds (final scale ~110% of starting frame). The image content is identical to the source photograph throughout — same car position, same number plate, same background, same lighting. Nothing in the photograph moves; only the magnification gradually grows.
- AUDIO: "A South African woman speaks the voiceover in her natural South African English accent (the typical accent heard in Johannesburg, Cape Town, or Pretoria — clear, warm, neutral South African, NOT British, NOT American, NOT Australian). Her voice is the only voice in the clip, calm and unhurried, fully audible and front-and-centre in the mix. Background sound is very low: [Write a catchy 1-sentence hook introducing the make and model. MAX 14 words, aim for 11–13. Must fit comfortably in a 10-second clip with room to breathe at the end.]"

Scene 2: Dashboard / Cockpit
- A still photograph of the ${car.make} ${car.model} dashboard held on screen, slowly zooming in over 10 seconds (final scale ~110% of starting frame). The dashboard, displays, and steering wheel are identical to the source photograph throughout. The steering wheel is on the RIGHT side (right-hand-drive vehicle). Nothing in the photograph moves; only the magnification gradually grows.
- AUDIO: "A South African woman speaks the voiceover in her natural South African English accent (the typical accent heard in Johannesburg, Cape Town, or Pretoria — clear, warm, neutral South African, NOT British, NOT American, NOT Australian). Her voice is the only voice in the clip, calm and unhurried, fully audible and front-and-centre in the mix. Background sound is very low: [Write a 1-sentence voiceover mentioning 1 or 2 of its best technology features. MAX 14 words, aim for 11–13. Must fit comfortably in a 10-second clip — say less rather than rush.]"

Scene 3: Rear Cabin
- A still photograph of the ${car.make} ${car.model} rear cabin held on screen, slowly zooming in over 10 seconds (final scale ~110% of starting frame). The seats, trim, and view through the windows are identical to the source photograph throughout. Nothing in the photograph moves; only the magnification gradually grows.
- AUDIO: "A South African woman speaks the voiceover in her natural South African English accent (the typical accent heard in Johannesburg, Cape Town, or Pretoria — clear, warm, neutral South African, NOT British, NOT American, NOT Australian). Her voice is the only voice in the clip, calm and unhurried, fully audible and front-and-centre in the mix. Background sound is very low: [Write a 1-sentence voiceover mentioning its comfort or powertrain features. MAX 14 words, aim for 11–13. Must fit comfortably in a 10-second clip — say less rather than rush.]"

Scene 4: Closer (Different exterior angle of the same car)
- A still photograph of the ${car.make} ${car.model} from a DIFFERENT exterior angle than Scene 1 — typically a rear three-quarter view, side profile, or wider establishing shot of the same vehicle. The source photograph stays exactly as supplied; do not invent a presenter or any person, and do not add any logos, text, or graphical overlays. The image is held on screen and slowly zooms in over 10 seconds (final scale ~110% of starting frame).
- The vehicle, surroundings, ground, sky, and lighting all stay exactly as in the source image. Nothing in the photograph moves; only the on-screen magnification grows. There is no panning, no rotation, no angle change, no perspective shift, and no element is added to or removed from the scene.
- AUDIO: "A South African woman speaks the voiceover in her natural South African English accent (the typical accent heard in Johannesburg, Cape Town, or Pretoria — clear, warm, neutral South African, NOT British, NOT American, NOT Australian). Her voice is the only voice in the clip, calm and unhurried, fully audible and front-and-centre in the mix. Background sound is very low: [Write a unique, premium 1-sentence Call to Action urging the viewer to contact, visit, or enquire with Everest Motoring regarding this specific make/model. MAX 14 words, aim for 11–13. Must fit comfortably in a 10-second clip — say less rather than rush. Avoid the word 'new'. Avoid the phrase 'test drive'.]"
...
Example Output:
[
  { "scene": 1, "location": "exterior", "visual_prompt": "A still photograph of the [year make model] held on screen for 10 seconds, slowly zooming in to ~110% of starting scale. The image content is identical to the source throughout — nothing moves, only the magnification grows. AUDIO: ...", "voiceover_text": "The striking 2022 BMW X5 — refined, capable, ready for the road." },
  { "scene": 2, "location": "interior", "visual_prompt": "A still photograph of the [year make model] dashboard held on screen for 10 seconds, slowly zooming in to ~110%. Steering wheel on the RIGHT. Nothing moves, only the scale grows. AUDIO: ...", "voiceover_text": "Apple CarPlay and premium audio bring the cockpit confidently to life." },
  { "scene": 3, "location": "interior", "visual_prompt": "A still photograph of the [year make model] rear cabin held on screen for 10 seconds, slowly zooming in to ~110%. Nothing moves, only the scale grows. AUDIO: ...", "voiceover_text": "Leather seats and climate control make every long drive feel effortless." },
  { "scene": 4, "location": "exterior", "visual_prompt": "A still photograph of the [year make model] from a DIFFERENT exterior angle to scene 1 (rear three-quarter, side profile, or wider establishing shot of the same vehicle). Held on screen for 10 seconds, slowly zooming in to ~110%. No people, no overlays, nothing added — just the photograph being magnified. AUDIO: ...", "voiceover_text": "Visit Everest Motoring in White River to see this one in person." }
]
`;
        ...
        // ===== Scene 1 hook variants — kept short (well under the 14-word
        // cap) so the voiceover sits comfortably inside a 10-second clip. =====
        ...
        const zoomRule = "The source photograph is held on screen for 10 seconds and slowly scales up from 100% to ~110%. Nothing in the photograph moves; only the on-screen magnification grows. Treat the input as a flat photograph being magnified, not a 3D scene being filmed. There is no panning, no rotation, no angle change, no perspective shift — one continuous fluid zoom-in from frame one to the last frame.";
        const cleanAudio = "A South African woman speaks the voiceover in her natural South African English accent (the typical accent heard in Johannesburg, Cape Town, or Pretoria — clear, warm, neutral South African, NOT British, NOT American, NOT Australian). Her voice is the only voice in the clip, calm and unhurried, fully audible and front-and-centre in the mix. Background sound is very low";

        return [
            { scene: 1, location: "exterior", voiceover_text: hookLine, visual_prompt: `A still photograph of the ${car.year} ${car.make} ${car.model} parked outside, held on screen for 10 seconds. ${zoomRule} AUDIO: ${cleanAudio}: '${hookLine}'` },
            { scene: 2, location: "interior", voiceover_text: techLine, visual_prompt: `A still photograph of the ${car.make} ${car.model} dashboard, held on screen for 10 seconds. The steering wheel is on the RIGHT side (right-hand-drive). ${zoomRule} AUDIO: ${cleanAudio}: '${techLine}'` },
            { scene: 3, location: "interior", voiceover_text: comfortLine, visual_prompt: `A still photograph of the ${car.make} ${car.model} rear cabin, held on screen for 10 seconds. ${zoomRule} AUDIO: ${cleanAudio}: '${comfortLine}'` },
            { scene: 4, location: "exterior", voiceover_text: ctaLine, visual_prompt: `A still photograph of the ${car.make} ${car.model} from a DIFFERENT exterior angle to scene 1 (typically a rear three-quarter view or side profile of the same vehicle). The source photograph is shown exactly as supplied — no people, no overlays, no logos or text added, nothing in the scene is invented or removed. The image is held on screen for 10 seconds. ${zoomRule} AUDIO: ${cleanAudio}: '${ctaLine}'` }
        ];
    }
}
