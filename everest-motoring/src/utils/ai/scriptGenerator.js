...
- AUDIO: "VOICE ONLY — clean, studio-quality South African English Female Voiceover. ZERO background sound: no music, no engine noise, no ambient sound, no traffic, no birds, no wind, no SFX, no foley, no room tone, no static, no hiss, no interference. The audio track contains only the voiceover on a perfectly silent background — no other sound exists in the clip: [Write a catchy 1-sentence hook introducing the make and model. MAX 11 words, aim for 8–10. Must fit comfortably in an 8-second clip at a calm, unhurried pace.]"
...
- AUDIO: "VOICE ONLY — clean, studio-quality South African English Female Voiceover. ZERO background sound: no music, no engine noise, no ambient sound, no traffic, no road noise, no SFX, no foley, no room tone, no static, no hiss, no interference. The audio track contains only the voiceover on a perfectly silent background — no other sound exists in the clip: [Write a 1-sentence voiceover mentioning 1 or 2 of its best technology features. MAX 11 words, aim for 8–10. Must fit comfortably in an 8-second clip at a calm, unhurried pace — say less rather than rush.]"
...
- AUDIO: "VOICE ONLY — clean, studio-quality South African English Female Voiceover. ZERO background sound: no music, no engine noise, no ambient sound, no traffic, no fabric rustle, no SFX, no foley, no room tone, no static, no hiss, no interference. The audio track contains only the voiceover on a perfectly silent background — no other sound exists in the clip: [Write a 1-sentence voiceover mentioning its comfort or powertrain features. MAX 11 words, aim for 8–10. Must fit comfortably in an 8-second clip at a calm, unhurried pace — say less rather than rush.]"
...
- AUDIO: "VOICE ONLY — clean, studio-quality South African English Female Voiceover. ZERO background sound: no music, no ambient sound, no traffic, no birds, no wind, no SFX, no foley, no room tone, no static, no hiss, no interference, no breath sounds. The audio track contains only the voiceover on a perfectly silent background — no other sound exists in the clip: [Write a unique, premium 1-sentence Call to Action urging the viewer to contact, visit, or enquire with Everest Motoring regarding this specific make/model. MAX 11 words, aim for 8–10. Must fit comfortably in an 8-second clip at a calm, unhurried pace — say less rather than rush. Avoid the word 'new'. Avoid the phrase 'test drive'.]"
...
`;
        ...
        const cleanAudio = "VOICE ONLY — clean, studio-quality South African English Female Voiceover. ZERO background sound: no music, no engine noise, no ambient sound, no traffic, no birds, no wind, no fabric rustle, no SFX, no foley, no room tone, no static, no hiss, no interference. The audio track contains only the voiceover on a perfectly silent background — no other sound exists in the clip";
