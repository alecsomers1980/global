...
2d. VOICEOVER LENGTH — STRICT: every voiceover line must be MAX 12 WORDS. Each clip is 7 seconds long, so the line must comfortably fit at a calm, unhurried pace. If you cannot fit your point in 12 words, say less — drop a feature, drop an adjective, drop the lead-in. A short, well-spoken line is far better than a long line that gets cut off mid-sentence. Aim for 9–11 words.
3. Keep visual descriptions concise. Describe each scene as a photo animation, not a camera shoot. Avoid words like "shot", "tracking", "push-in", "cinematic", "POV" — these prime the AI to attempt 3D camera moves. Keep each visual_prompt to 2–3 short sentences before AUDIO.
4. MOTION — every scene is a still photograph being slowly zoomed-in over 7 seconds (Ken Burns / cinemagraph style). The image's content does not move; only its on-screen scale grows from roughly 100% to roughly 110% by the end of the clip. There is no panning, no rotation, no angle change, no perspective shift, and nothing in the scene itself moves. The source photograph remains the same throughout — only its magnification gradually increases.
5. BACKGROUND PRESERVATION — STRICT (applies to EVERY scene, especially scene 1): the background of the source photograph must be preserved EXACTLY as supplied. Do NOT change, restyle, replace, or "enhance" the background. Do NOT swap the location, sky, weather, ground, walls, parking surface, surroundings, lighting, or any environmental element. Do NOT add new objects, people, signage, logos, atmospheric effects (haze, mist, rain, lens flares), or motion of any kind in the background. Do NOT relocate the car or change what is visible behind, beside, above, or below it. The background of every frame must be visually IDENTICAL to the background in the source photograph — pixel-for-pixel apart from the gradual magnification.
6. GEOMETRY & SUBJECT PRESERVATION — STRICT (applies to EVERY scene, especially the interior scenes 2 and 3): the shapes, proportions, perspective, and physical structure visible in the source photograph must be preserved EXACTLY as supplied. The model must NEVER re-render the scene as if it were 3D — no perspective re-projection, no parallax shift, no re-imagining of seat shapes, belt geometry, dashboard layout, trim panels, steering wheel position, mirror placement, or any object's outline. Do NOT distort, warp, stretch, bend, or "rationalize" any part of the image. Do NOT change the camera angle even slightly. Do NOT add or remove objects from the cabin. Treat the input as a printed photograph being held in front of a camera and slowly enlarged — every pixel's position relative to every other pixel stays the same; only the overall on-screen scale grows.

Scene Breakdown:

(STYLE — applies to all four scenes: each clip is a SINGLE FLUID 8-second photo animation. The source reference image is held on screen and slowly scales up by ~10%. Treat the input strictly as a flat photograph being magnified — not a 3D scene being filmed. The image's framing, angle, perspective, lighting, content, AND BACKGROUND are identical from frame one to the last frame; only the zoom level grows. The animation is one continuous fluid motion with no cuts, no angle changes, no panning, and no mid-clip variation. The background of the source photograph must never be altered, swapped, restyled, or have anything added to or removed from it.)

Scene 1: Exterior Hero
- A still photograph of the ${car.make} ${car.model} held on screen, slowly zooming in over 7 seconds (final scale ~110% of starting frame). The image content is identical to the source photograph throughout — same car position, same number plate, same background, same ground, same surroundings, same lighting. The background must be preserved EXACTLY as supplied — do NOT change the location, sky, walls, ground, parking surface, or any environmental detail behind or around the car. Nothing in the photograph moves; only the magnification gradually grows.
...
- A still photograph of the ${car.make} ${car.model} dashboard held on screen, slowly zooming in over 7 seconds (final scale ~110% of starting frame). The dashboard, displays, instrument cluster, steering wheel, vents, infotainment screen, and trim are IDENTICAL to the source photograph throughout — same shapes, same proportions, same perspective, same positions. The steering wheel is on the RIGHT side (right-hand-drive vehicle) and must stay on the right. Do NOT re-render the cockpit in 3D, do NOT shift perspective, do NOT distort or warp any element of the dashboard, do NOT add or remove buttons, displays, or trim pieces. Nothing in the photograph moves; only the magnification gradually grows.
- AUDIO: "A South African woman speaks the voiceover in her natural South African English accent (the typical accent heard in Johannesburg, Cape Town, or Pretoria — clear, warm, neutral South African, NOT British, NOT American, NOT Australian). Her voice is the only voice in the clip, calm and unhurried, fully audible and front-and-centre in the mix. Background sound is very low: [Write a 1-sentence voiceover mentioning 1 or 2 of its best technology features. MAX 12 words, aim for 9–11. Must fit comfortably in a 7-second clip — say less rather than rush.]"

Scene 3: Rear Cabin
- A still photograph of the ${car.make} ${car.model} rear cabin held on screen, slowly zooming in over 7 seconds (final scale ~110% of starting frame). The rear seats, headrests, seat belts, belt buckles, armrest, trim, door cards, floor, and view through the windows are IDENTICAL to the source photograph throughout — same shapes, same proportions, same perspective, same positions. Do NOT re-render the cabin in 3D, do NOT shift perspective or camera angle, do NOT warp, stretch, bend, or "rationalize" any seat or belt geometry, do NOT add or remove cabin elements, do NOT invent textures or details that aren't in the source. The cabin must look like the SAME photograph being slowly enlarged — every pixel's position relative to every other pixel stays the same. Nothing in the photograph moves; only the magnification gradually grows.
...
- A still photograph of the ${car.make} ${car.model} — the IDENTICAL hero exterior photograph used in Scene 1, held on screen and slowly zooming in over 7 seconds (final scale ~110% of starting frame). The image content is identical to the Scene 1 source throughout: same car position, same number plate, same background, same lighting, same angle, same framing. Do NOT add any person, presenter, logos, text, or graphical overlay. Do NOT change the background, angle, or perspective. Nothing in the photograph moves; only the magnification gradually grows.
- AUDIO: "A South African woman speaks the voiceover in her natural South African English accent (the typical accent heard in Johannesburg, Cape Town, or Pretoria — clear, warm, neutral South African, NOT British, NOT American, NOT Australian). Her voice is the only voice in the clip, calm and unhurried, fully audible and front-and-centre in the mix. Background sound is very low: [Write a unique, premium 1-sentence Call to Action urging the viewer to contact, visit, or enquire with Everest Motoring regarding this specific make/model. MAX 12 words, aim for 9–11. Must fit comfortably in a 7-second clip — say less rather than rush. Avoid the word 'new'. Avoid the phrase 'test drive'.]"
...
Example Output:
[
  { "scene": 1, "location": "exterior", "visual_prompt": "A still photograph of the [year make model] held on screen for 7 seconds, slowly zooming in to ~110% of starting scale. The image content is identical to the source throughout — nothing moves, the background is preserved exactly, only the magnification grows. AUDIO: ...", "voiceover_text": "The striking 2022 BMW X5 — refined, capable, ready." },
  { "scene": 2, "location": "interior", "visual_prompt": "A still photograph of the [year make model] dashboard held on screen for 7 seconds, slowly zooming in to ~110%. Steering wheel on the RIGHT. Nothing moves, only the scale grows. AUDIO: ...", "voiceover_text": "Apple CarPlay and premium audio, exactly where you need them." },
  { "scene": 3, "location": "interior", "visual_prompt": "A still photograph of the [year make model] rear cabin held on screen for 7 seconds, slowly zooming in to ~110%. Nothing moves, only the scale grows. AUDIO: ...", "voiceover_text": "Leather comfort built for unhurried long drives." },
  { "scene": 4, "location": "exterior", "visual_prompt": "A still photograph of the [year make model] — the IDENTICAL hero exterior photograph used in scene 1. Held on screen for 7 seconds, slowly zooming in to ~110%. Same image, same angle, same background. No people, no overlays, nothing added — just the photograph being magnified. AUDIO: ...", "voiceover_text": "Visit Everest Motoring in White River to see it in person." }
]
`;
        ...
        // cap) so the voiceover sits comfortably inside a 7-second clip. =====
        ...
        const zoomRule = "The source photograph is held on screen for 7 seconds and slowly scales up from 100% to ~110%. Nothing in the photograph moves; only the on-screen magnification grows. Treat the input as a flat photograph being magnified, not a 3D scene being filmed. There is no panning, no rotation, no angle change, no perspective shift — one continuous fluid zoom-in from frame one to the last frame. The background must be preserved exactly as supplied.";
        const cleanAudio = "A South African woman speaks the voiceover in her natural South African English accent (the typical accent heard in Johannesburg, Cape Town, or Pretoria — clear, warm, neutral South African, NOT British, NOT American, NOT Australian). Her voice is the only voice in the clip, calm and unhurried, fully audible and front-and-centre in the mix. Background sound is very low";

        return [
            { scene: 1, location: "exterior", voiceover_text: hookLine, visual_prompt: `A still photograph of the ${car.year} ${car.make} ${car.model} parked outside, held on screen for 7 seconds. ${zoomRule} AUDIO: ${cleanAudio}: '${hookLine}'` },
            { scene: 2, location: "interior", voiceover_text: techLine, visual_prompt: `A still photograph of the ${car.make} ${car.model} dashboard, held on screen for 7 seconds. The steering wheel is on the RIGHT side (right-hand-drive). ${zoomRule} AUDIO: ${cleanAudio}: '${techLine}'` },
            { scene: 3, location: "interior", voiceover_text: comfortLine, visual_prompt: `A still photograph of the ${car.make} ${car.model} rear cabin, held on screen for 7 seconds. ${zoomRule} AUDIO: ${cleanAudio}: '${comfortLine}'` },
            { scene: 4, location: "exterior", voiceover_text: ctaLine, visual_prompt: `A still photograph of the ${car.year} ${car.make} ${car.model} — the IDENTICAL hero exterior photograph used in scene 1, with the same car position, background, angle, and lighting. No people, no overlays, no logos or text added. The image is held on screen for 7 seconds. ${zoomRule} AUDIO: ${cleanAudio}: '${ctaLine}'` }
        ];
    }
}
