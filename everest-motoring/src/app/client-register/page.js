...
export default function ClientRegisterPage({ searchParams }) {
        ...
        <div className="min-h-[calc(100vh-80px)] bg-slate-50 flex items-center justify-center p-4 py-12">
            <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100">
                ...
                <div className="bg-slate-950 p-8 text-center border-b-4 border-primary">
                    ...
                    />
                    <h1 className="text-3xl font-bold text-white mb-2">Client Portal Registration</h1>
                    <p className="text-slate-400">Track your vehicle financing securely in one place.</p>
                </div>
                ...
                <div className="p-8 md:p-10">
                    ...
                    <form className="space-y-6" action="/auth/register-client" method="POST">
                        {/* Hidden input to pass the car ID if they are registering for a specific vehicle */}
