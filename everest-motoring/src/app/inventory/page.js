...
export default async function InventoryPage() {
    ...
    // Fetch only ALL available cars (hide reserved/sold unless specifically requested)
    ...
    return (
        <div className="bg-background-alt min-h-screen py-16 px-4 lg:px-12">
            <div className="max-w-7xl mx-auto">
                <h1 className="text-4xl font-bold font-display text-slate-900 mb-2">Our Premium Fleet</h1>
                <p className="text-slate-500 mb-12">Browse our exclusive collection of 100-point checked vehicles.</p>
