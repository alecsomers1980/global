                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-slate-50 border-b border-slate-200 text-slate-500 text-sm uppercase tracking-wider">
                            ...
                            <th className="p-4 font-bold col-span-2">Vehicle Details</th>
                            <th className="p-4 font-bold">Offer Value</th>
                            ...
                            <React.Fragment key={req.id}>
                                <tr className="hover:bg-slate-50 transition-colors cursor-pointer" onClick={() => toggleExpand(req.id)}>
                                    <td className="p-4">
                                        ...
                                        <p className="text-sm text-slate-600 flex items-center gap-1 mt-1 ml-6">
