import {
  Body, Container, Head, Heading, Html, Img, Link, Preview, Section, Text, Tailwind, Button,
        ...
        <Body className="bg-neutral-100 font-sans">
          <Container width="600" className="mx-auto my-10 w-[600px] max-w-full bg-white border border-neutral-200 rounded-2xl overflow-hidden">
            ...
            <Section className="px-10 pb-6">
              <Img src="https://images.unsplash.com/photo-1464349153735-7db50ed83c84?auto=format&fit=crop&q=80&w=800" width="520" height="auto" alt="Celebration" className="rounded-xl object-cover w-full h-auto" />
            </Section>
            <Section className="px-10 pb-8">
              <Section className="bg-neutral-50 border-2 border-dashed border-primary-dark rounded-xl px-6 py-8 text-center">
                ...
                <Button className="bg-primary text-black font-bold py-4 px-8 rounded-lg" href="https://everestmotoring.co.za/contact">Book Your Car Wash</Button>
              </Section>
            </Section>
