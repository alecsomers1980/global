      ...
      <Tailwind config={brandConfig}>
        ...
        <Body className="bg-neutral-100 font-sans">
          <Container className="mx-auto my-6 w-[600px] max-w-full bg-white border border-neutral-200 rounded-2xl overflow-hidden">
            ...
            <Section className="px-10 pb-6 border-t border-neutral-200 pt-8">
            ...
            {/* New Arrivals */}
            <Section className="bg-neutral-50 px-10 py-8 border-t border-neutral-200">
            ...
            {/* Niche tips */}
            <Section className="px-10 py-8 border-t border-neutral-200">
              <Heading as="h3" className="text-lg font-bold text-neutral-900 uppercase tracking-wider m-0 mb-4">
                Smart Buyer Tips
              </Heading>
              {tips.map((tip, idx) => (
                <Section key={idx} className="border-l-4 border-primary bg-neutral-50 rounded-r-lg px-4 py-3 mb-3">
