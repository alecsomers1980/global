                        ...
                        <div className="space-y-16 lg:space-y-24">
                            ...
                            <div className="grid md:grid-cols-2 gap-10 items-center">
                                ...
                                <div className="space-y-6 md:pl-8">
                                    ...
                                    <p className="text-lg text-charcoal/80 leading-relaxed font-medium">
                                        Precision cutting and engraving are essential for creating custom 3D signage, lightboxes, and architectural elements and set building. Our CNC ROUTER 3020 provides the heavy-duty power and meticulous accuracy needed to carve through acrylic, wood, aluminium, and composite materials with ease.
                                    </p>
                                    <div className="bg-white rounded-xl p-6 border border-border-grey shadow-sm">
                                        <p className="font-bold text-aloe-green mb-2 uppercase tracking-wider text-sm">Why it matters for you:</p>
                                        <p className="text-charcoal/80">
