...
export default function HeroBanner() {
    ...
    return (
        <section className="relative h-[65vh] md:h-[70vh] bg-charcoal flex items-center overflow-hidden">
            ...
            <div className="relative h-full w-full max-w-[1400px] mx-auto px-6 flex flex-col justify-center pt-24 items-center md:items-end z-20">
                <div className="max-w-2xl text-center md:text-right flex flex-col items-center md:items-end">
                    ...
                    >
                        ...
                        {/* Main Big, Loud Title */}
                        <h2 className="text-2xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 uppercase leading-none tracking-tight">
                            {activeSlide.title}
                        </h2>

                        {/* Power Sub-line */}
                        <p className="text-xl md:text-2xl font-medium text-white/90 mb-10 max-w-xl">
                        ...
                        <div className="flex flex-wrap justify-center md:justify-end gap-4 mb-8 w-full">
                            <Link
                                ...
                                className="px-10 py-5 bg-aloe-green text-charcoal font-black rounded-full uppercase tracking-wider hover:bg-white transition-colors text-lg md:text-xl shadow-[0_0_20px_rgba(202,238,166,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.7)]"
                            >
