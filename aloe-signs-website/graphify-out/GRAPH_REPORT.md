# Graph Report - aloe-signs-website  (2026-08-02)

## Corpus Check
- 211 files · ~103,681 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 830 nodes · 1260 edges · 104 communities (68 shown, 36 thin omitted)
...
## Knowledge Gaps
- **241 isolated node(s):** `usedImageUrls`, `NewsArticle`, `{ sql }`, `metadata`, `Order` (+236 more)
...
- **What connects `usedImageUrls`, `NewsArticle`, `{ sql }` to the rest of the system?**
