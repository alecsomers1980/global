    ...
    <footer className="bg-brand-navy text-white" id="contact">
      <div className="container mx-auto px-6 py-20">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3">
          {/* Contact Details */}
          <div>
            <h3 className="section-label mb-6">Contact Details</h3>
            <div className="space-y-4">
              <div>
                <p className="text-sm text-white/50">Head Office</p>
                <a
                  href="tel:+27114773920"
                  className="text-lg font-semibold transition-colors hover:text-brand-teal"
                >
                  +27 11 477 3920
                </a>
              </div>
          ...
          {/* Address */}
          <div>
            <h3 className="section-label mb-6">Address</h3>
            <a
          ...
          {/* Social & Quick Links */}
          <div>
            <h3 className="section-label mb-6">Discover us!</h3>
            <div className="mb-8 flex gap-3">
              {[
                ...
                <a
                  ...
                  className="rounded-full bg-white/10 p-2.5 transition-all duration-300 hover:scale-110 hover:bg-brand-teal hover:text-white"
                >
                  {social.icon}
                </a>
              ))}
