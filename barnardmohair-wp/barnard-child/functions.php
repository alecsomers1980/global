...
/**
 * Replace ?add-to-cart=ID links on shop/archive pages with the product permalink.
 * Fixes SEO audit "unfriendly URL" flag. Variable products already link to the
 * product page; this brings simple products in line with the same behaviour.
 */
add_filter( 'woocommerce_loop_add_to_cart_link', 'barnard_loop_product_link', 10, 2 );
function barnard_loop_product_link( $link, $product ) {
    return sprintf(
        '<a href="%s" class="button wp-element-button">%s</a>',
