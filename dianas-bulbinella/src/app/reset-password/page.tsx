...
export default function ResetPasswordPage() {
  ...
  // Stable client reference so the effect below runs once, not every render.
  ...
  useEffect(() => {
    // The recovery session may be established before this listener attaches,
    // so also check for an existing session on mount.
    ...
    return (
      <div className="max-w-md mx-auto px-6 py-16">
        <div className="bg-paper border border-line rounded-2xl p-8 shadow-sm text-center">
          <h1 className="text-2xl font-serif text-ink mb-4">Choose a new password</h1>
  ...
  if (success) {
    return (
      <div className="max-w-md mx-auto px-6 py-16">
        <div className="bg-paper border border-line rounded-2xl p-8 shadow-sm text-center">
          <h1 className="text-2xl font-serif text-ink mb-4">Password updated</h1>
  ...
  return (
    <div className="max-w-md mx-auto px-6 py-16">
      <div className="bg-paper border border-line rounded-2xl p-8 shadow-sm">
        <h1 className="text-2xl font-serif text-ink mb-6">Choose a new password</h1>
