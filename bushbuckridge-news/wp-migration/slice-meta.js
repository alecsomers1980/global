...
function sliceMeta() {
    ...
    const matchStr = 'INSERT INTO `wp_postmeta`';
    ...
    while (true) {
        ...
        // We append a comma and newline to combine the blocks
    ...
    fs.writeFileSync('wp_postmeta_block.txt', allTuples, 'utf8');
    console.log(`Successfully combined ${count} wp_postmeta inserts. Total Length: ${allTuples.length}`);
}
