...
export type AllPreparedStatementNodes = AllPreparedStatements | PrepareFromClause | DeallocateAll | ExecuteIntoClause | ExecuteUsingClause;
export type AllPreparedStatements = PrepareStmt | DeallocateStmt | ExecuteStmt | ExecuteImmediateStmt;
...
export interface DeallocateStmt extends BaseNode {
    ...
    deallocateKw: Keyword<"DEALLOCATE"> | [Keyword<"DEALLOCATE">, Keyword<"PREPARE">] | [Keyword<"DROP">, Keyword<"PREPARE">];
