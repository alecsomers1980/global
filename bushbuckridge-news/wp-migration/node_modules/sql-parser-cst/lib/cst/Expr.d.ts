...
import { PostgresqlOperator, PostgresqlOperatorExpr } from "./dialects/Postgresql";
export type AllExprNodes = Expr | FuncArgs | NamedArg | CastArg | CastFormat | CastFormatTimezone | RaiseExprType | ExtractFrom | FilterArg | OverArg | HavingArg | CaseWhen<Expr | Program> | CaseElse<Expr | Program> | WeekExpr | FullTextMatchArgs | ArraySubscript | ArraySubscriptSpecifier | ArraySliceSpecifier;
export type Expr = ListExpr | ParenExpr | BinaryExpr | BinaryExpr<TriggerEventExpr, Keyword<"OR">, TriggerEventExpr> | PrefixOpExpr | PostfixOpExpr | FuncCall | CastExpr | CastOperatorExpr | RaiseExpr | ExtractExpr | BetweenExpr | CaseExpr | RowConstructor | ArrayConstructor | StringWithCharset | QuantifierExpr | FullTextMatchExpr | Literal | MemberExpr | BigQueryQuotedMemberExpr | Identifier | Variable | Parameter | TypedExpr | ArrayLiteralExpr | ArrayExpr | StructExpr;
...
export interface BinaryExpr<TLeft = Expr, TOperator = SymbolOperator | KeywordOperator | PostgresqlOperatorExpr, TRight = Expr> extends BaseNode {
    type: "binary_expr";
    left: TLeft;
    operator: TOperator;
    right: TRight;
...
export interface PrefixOpExpr extends BaseNode {
    type: "prefix_op_expr";
    operator: "-" | "+" | "~" | "!" | Keyword<"NOT"> | Keyword<"EXISTS"> | PostgresqlOperatorExpr;
    expr: Expr;
}
export interface PostfixOpExpr extends BaseNode {
    type: "postfix_op_expr";
    operator: Keyword<"ISNULL"> | Keyword<"NOTNULL"> | [Keyword<"NOT">, Keyword<"NULL">] | [Keyword<"IS">, Keyword<"UNKNOWN">] | [Keyword<"IS">, Keyword<"NOT">, Keyword<"UNKNOWN">] | [Keyword<"IS">, Keyword<"NORMALIZED">] | [Keyword<"IS">, Keyword<"NOT">, Keyword<"NORMALIZED">] | [Keyword<"IS">, NormalizationForm, Keyword<"NORMALIZED">] | [Keyword<"IS">, Keyword<"NOT">, NormalizationForm, Keyword<"NORMALIZED">];
    expr: Expr;
}
...
export interface BetweenExpr extends BaseNode {
    type: "between_expr";
    left: Expr;
    betweenKw: Keyword<"BETWEEN"> | [Keyword<"NOT">, Keyword<"BETWEEN">] | [Keyword<"BETWEEN">, Keyword<"SYMMETRIC">] | [Keyword<"NOT">, Keyword<"BETWEEN">, Keyword<"SYMMETRIC">];
    begin: Expr;
    andKw: Keyword<"AND">;
    end: Expr;
}
...
export interface FullTextMatchArgs extends BaseNode {
    ...
    expr: Expr;
    modifier?: [Keyword<"IN">, Keyword<"NATURAL">, Keyword<"LANGUAGE">, Keyword<"MODE">] | [
        Keyword<"IN">,
        Keyword<"NATURAL">,
        Keyword<"LANGUAGE">,
        Keyword<"MODE">,
        ...
        Keyword<"QUERY">,
        Keyword<"EXPANSION">
    ] | [Keyword<"IN">, Keyword<"BOOLEAN">, Keyword<"MODE">] | [Keyword<"WITH">, Keyword<"QUERY">, Keyword<"EXPANSION">];
}
export interface MemberExpr extends BaseNode {
    type: "member_expr";
    object: Expr;
    property: ArraySubscript | Identifier | AllColumns | Empty | PostgresqlOperator;
}
