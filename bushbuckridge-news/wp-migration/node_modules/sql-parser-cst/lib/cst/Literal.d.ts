...
export type Literal = StringLiteral | NumberLiteral | BlobLiteral | BooleanLiteral | NullLiteral | DatetimeLiteral | TimeLiteral | DateLiteral | TimestampLiteral | JsonLiteral | JsonbLiteral | NumericLiteral | BignumericLiteral | IntervalLiteral;
