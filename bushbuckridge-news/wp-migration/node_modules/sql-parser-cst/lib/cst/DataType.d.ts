...
export type AllDataTypeNodes = DataTypeName | ModifiedDataType | ParametricDataType | ArrayDataType | SetofDataType | TimeDataType | IntervalDataType | TableDataType | GenericTypeParams | ArrayTypeParam | StructTypeParam | ArrayBounds | IntervalUnit | IntervalUnitRange;
export type DataType = EntityName | DataTypeName | ModifiedDataType | ParametricDataType | ArrayDataType | SetofDataType | TimeDataType | IntervalDataType | TableDataType;
...
export interface IntervalUnit extends BaseNode {
    type: "interval_unit";
    unitKw: Keyword<"CENTURY" | "DAY_HOUR" | "DAY_MICROSECOND" | "DAY_MINUTE" | "DAY_SECOND" | "DAY" | "DECADE" | "DOW" | "DOY" | "EPOCH" | "HOUR_MICROSECOND" | "HOUR_MINUTE" | "HOUR_SECOND" | "HOUR" | "ISODOW" | "ISOYEAR" | "JULIAN" | "MICROSECOND" | "MICROSECONDS" | "MILLENNIUM" | "MILLISECONDS" | "MINUTE_MICROSECOND" | "MINUTE_SECOND" | "MINUTE" | "MONTH" | "QUARTER" | "SECOND_MICROSECOND" | "SECOND" | "TIMEZONE_HOUR" | "TIMEZONE_MINUTE" | "TIMEZONE" | "WEEK" | "YEAR_MONTH" | "YEAR">;
